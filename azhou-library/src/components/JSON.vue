...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="storeType in Object.entries(bookstores.storeTypes)" :key="storeType">
          Number of {{ storeType[0] }} stores: {{ storeType[1] }}
        </li>
      </ul>
      ...
      <ul>
        <li v-for="openDays in Object.entries(bookstores.openingHours)" :key="openDays">
          {{ openDays[0].toUpperCase() }}: {{ openDays[1].open }} to
          {{ openDays[1].close }}
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <p :style="{ color: textColorHighlight, fontSize: fontSize + 'px' }">
...
// Highlight Author Setup
const textColorHighlight = ref('yellow')
